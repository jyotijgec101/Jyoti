  ...
  return (
    <div className="flex justify-center px-8 pt-14 lg:p-14 items-center">
      <div className=" certiback flex lg:flex-row flex-col md:flex-row lg:justify-evenly md:justify-evenly md:items-center lg:items-center  lg:gap-14 gap-8   p-10  rounded-lg lg:w-[80%] md:w-full lg:h-[60vh] h-[60vh]">
        ...
        <div className="flex gap-4 p-4 lg:justify-center lg:items-center flex-col lg:mt-14 lg:w-[40%] lg:h-[50vh]  pb-14">
          <form
          ...
          >
            <div>
              <input
                ...
                className="lg:p-3 p-2 pr-10 lg:pr-28 focus:outline-none rounded-lg  placeholder:text-[15px]"
                placeholder="Certificate No."
              />
              <div className="m-4 border-[3px] border-amber-900"></div>
            </div>
            <div>
              <button className=" p-[12px] ml-4 px-[24px] text-white verify rounded-lg hover:bg-amber-800 transition-transform duration-200">
                Verify
              </button>
            </div>
          </form>
