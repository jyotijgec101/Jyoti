          ...
          >
            <div>
              <input
                ...
                className="lg:p-4 p-2 pr-10 lg:pr-32 focus:outline-none rounded-lg  placeholder:text-[15px][appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none
                "
                required
